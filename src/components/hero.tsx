...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-20 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-background to-card transition-colors duration-300 overflow-hidden md:min-h-screen md:flex md:items-center">
