...
export function CTASection() {
  ...
  return (
    ...
    <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background via-card to-background text-foreground transition-colors duration-300 overflow-hidden">
